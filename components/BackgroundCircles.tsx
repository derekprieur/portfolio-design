...
const BackgroundCircles = (props: Props) => {
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ scale: [1, 2, 2, 3, 1], opacity: [0.1, 0.2, 0.4, 0.8, 0.1, 1.0], borderRadius: ['20%', '20%', '50%', '80%', '20%'] }}
            ...
            <div className=' rounded-full border border-cyan-500 opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse'></div>
